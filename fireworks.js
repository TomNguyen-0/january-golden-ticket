    ...
    var sfx = {
        ...
        blow : new Howl({ src: ['./start1.mp3']}),
        change: new Howl({ src: ['./change_2.wav']})
    }
    ...
    createFirework = function(user_clicked=false) {
        firework = new Firework(user_clicked);
    ...
    Firework = function(user_clicked) {
    ...
    text = function(time) {
        ...
        ctx.fillText("Congratulations You Won a Golden Ticket!", clientWidth/2, clientHeight/2);
        let newImage = new Image();
        newImage.src = './golden_ticket.png';
        ctx.drawImage(newImage, clientWidth/2-150/2, clientHeight/2,150,150);
        ctx.fillStyle='hsl('+hue+',100%,50%)';
        ctx.fillText("Add more fireworks with left-click.", clientWidth/2, clientHeight/2+180);
        ctx.fillText("Change fireworks (4)type with right-click.", clientWidth/2, clientHeight/2+210);
